    ...
    <div style="padding: 1.25rem 1.5rem; border-bottom: 1px solid var(--border-color); display: flex; justify-content: space-between; align-items: center; background: #ffffff;">
        <div>
            <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.25rem;">
                <a href="{{ route('departments.index') }}" style="text-decoration: none; color: #94a3b8; display: flex; align-items: center;" title="Quay lại">
            ...
            <p style="color: var(--text-body); font-size: var(--fs-xs);">Chọn lớp học để xem danh sách các môn học và sinh viên tương ứng.</p>
        </div>
            ...
            <tbody id="class-table-body">
                ...
                <tr class="table-row" style="border-bottom: 1px solid #f1f5f9;">
                    ...
                    <td style="padding: 0.85rem 1rem; text-align: right;">
                        <a href="{{ route('departments.index', ['department_id' => $department->id, 'classroom_id' => $cls->id]) }}" class="btn-icon" title="Chọn môn">
